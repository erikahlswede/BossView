...
Backbone.Marionette.BossView = Backbone.Marionette.BossView || {};

Backbone.Marionette.BossView.Mixin = {
...
Backbone.Marionette.BossView.ItemView = Backbone.Marionette.ItemView.extend(_.extend({
...
Backbone.Marionette.BossView.CompositeView = Backbone.Marionette.CompositeView.extend(_.extend({
    constructor: function () {
